...
class gmailController {
     ...
     */
    constructor(recipientList, transporter, message) {
        this.#gmailTransporter = transporter;
...
const gController = new gmailController([process.env.TESTEMAILADDRESS], gmailTransporter, message);
gController.sendGMail();
